...
{
	/** Qualifier of the <code>Recipe.cod</code> attribute **/
	...
	**/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Recipe.cod</code> attribute.
	 * @return the cod
	 */
	public String getCod(final SessionContext ctx)
	{
		return (String)getProperty( ctx, COD);
	}
	...
	{
		return getCod( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Recipe.cod</code> attribute. 
	 * @param value the cod
	 */
	public void setCod(final SessionContext ctx, final String value)
	{
